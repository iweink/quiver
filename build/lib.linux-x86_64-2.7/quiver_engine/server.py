...
def get_app(model, classes, top, html_base_dir, temp_folder='./tmp', input_folder='./'):
    ...
    def Pabspath(item):
      print("----------rr-")
      print("-----------" + filename for filename in listdir(abspath(input_folder)))
      abc = abspath(item)
      print(abc)
      return abc
    ...
    def get_inputs():
        ...
        print("----------rar-")
        return jsonify([
            filename for filename in listdir( Pabspath(input_folder))
        ])
